...
public class Aluno {
	...
	public void setNome(String nome) throws IllegalArgumentException {
		if (nome == null) throw new IllegalArgumentException("NOME INFORMADO � INVALIDO");
		else {
			this.nome = nome;
		}
	}
	...
	public String toString() {
		return String.format("CPF: %s, NOME: %s, IDADE: %d,ENDERE�O: %s, PLANO: %s, DATA DE ASSINATURA: %s", cpf, nome, idade, Arrays.toString(endereco),
