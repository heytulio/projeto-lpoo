...
public class Funcionario {
	...
	public Funcionario(String cpf, String nome, int idade, String[] endereco, double salario)
		...
		if (cpf == null || cpf.length() < 11) {
			throw new InvalidAttributeValueException("CPF INFORMADO N�O � VALIDO");
		} else {
			this.cpf = cpf;
		}
		if (nome == null) {
			throw new InvalidAttributeValueException("NOME INFORMADO N�O � VALIDO");
		} else {
			this.nome = nome;
		}
		...
		if (salario <= 0) {
			throw new InvalidAttributeValueException("SALARIO INFORMADO N�O � VALIDO");
		} else {
